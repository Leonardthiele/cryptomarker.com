defmodule PlatformWeb.HttpRedirectPlugTest do
  alias PlatformWeb.HttpRedirectPlug
  use PlatformWeb.ConnCase

  describe "#init" do
    test "passes the options unmodified" do
      opts = %{test: 123}
      assert HttpRedirectPlug.init(opts) == opts
    end
  end
  ...
  describe "#call" do
    test "redirects does nothing if there's no x-forwarded-proto http header" do
      ...
      response_1 = HttpRedirectPlug.call(conn, nil)
      response_2 = HttpRedirectPlug.call(conn_2, nil)
    ...
    test "test redirect of naked path" do
      ...
      response = HttpRedirectPlug.call(conn, nil)
